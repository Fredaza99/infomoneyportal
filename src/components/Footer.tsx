    ...
    <footer className="bg-gray-900 text-white pt-10 pb-6">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">InfoMoney</h3>
            <p className="text-gray-400 mb-4">
              Seu portal de notícias e informações com conteúdo de qualidade e atualizado em tempo real.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/economia" className="text-gray-400 hover:text-white transition-colors">
                  Economia
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/esportes" className="text-gray-400 hover:text-white transition-colors">
                  Esportes
                </Link>
              </li>
              <li>
                <Link href="/entretenimento" className="text-gray-400 hover:text-white transition-colors">
                  Entretenimento
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-8 pt-6 text-center text-gray-400">
          <p>&copy; {new Date().getFullYear()} InfoMoney. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
  );
